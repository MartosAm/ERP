...
var TurnosService = class _TurnosService {
  constructor() {
    this.api = inject(ApiService);
    this.turnoActivo = signal(null);
  }
  obtenerActivo() {
    return this.api.get("turnos-caja/activo").pipe(tap((turno) => this.turnoActivo.set(turno)));
  }
  obtenerPorId(id) {
    return this.api.get(`turnos-caja/${id}`);
  }
  listar(params) {
    return this.api.getPaginado("turnos-caja", params);
  }
  abrir(dto) {
    return this.api.post("turnos-caja/abrir", dto).pipe(tap((turno) => this.turnoActivo.set(turno)));
  }
  cerrar(turnoId, dto) {
    return this.api.post(`turnos-caja/${turnoId}/cerrar`, dto).pipe(tap(() => this.turnoActivo.set(null)));
  }
  static {
    this.\u0275fac = function TurnosService_Factory(t) {
      return new (t || _TurnosService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _TurnosService, factory: _TurnosService.\u0275fac, providedIn: "root" });
  }
};
...
function HeaderComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 4)(1, "mat-icon", 10);
    \u0275\u0275text(2, "circle");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 11);
    \u0275\u0275text(4, "Turno abierto");
    \u0275\u0275elementEnd()();
  }
}
var HeaderComponent = class _HeaderComponent {
  constructor() {
    ...
    this.turnos = inject(TurnosService);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], outputs: { toggleSidebar: "toggleSidebar" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 20, vars: 4, consts: [["userMenu", "matMenu"], [1, "header-bar"], ["mat-icon-button", "", "aria-label", "Abrir o cerrar men\xFA lateral", 3, "click"], [1, "flex-1"], [1, "turno-badge"], ["mat-icon-button", "", "aria-label", "Men\xFA de usuario", 3, "matMenuTriggerFor"], [1, "px-4", "py-2", "border-b"], [1, "font-medium"], [1, "text-xs", "text-gray-500"], ["mat-menu-item", "", 3, "click"], [1, "text-green-500", "text-sm"], [1, "text-sm", "ml-1"]], template: function HeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "mat-toolbar", 1)(1, "button", 2);
        \u0275\u0275listener("click", function HeaderComponent_Template_button_click_1_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.toggleSidebar.emit());
        });
        \u0275\u0275elementStart(2, "mat-icon");
        \u0275\u0275text(3, "menu");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(4, "span", 3);
        \u0275\u0275template(5, HeaderComponent_Conditional_5_Template, 5, 0, "span", 4);
        \u0275\u0275elementStart(6, "button", 5)(7, "mat-icon");
        \u0275\u0275text(8, "account_circle");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(9, "mat-menu", null, 0)(11, "div", 6)(12, "p", 7);
        \u0275\u0275text(13);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        let tmp_3_0;
        let tmp_4_0;
        const userMenu_r2 = \u0275\u0275reference(10);
        \u0275\u0275advance(5);
        \u0275\u0275conditional(5, ctx.turnos.turnoActivo() ? 5 : -1);
        \u0275\u0275advance();
        \u0275\u0275property("matMenuTriggerFor", userMenu_r2);
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate((tmp_3_0 = ctx.auth.usuario()) == null ? null : tmp_3_0.nombre);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate((tmp_4_0 = ctx.auth.usuario()) == null ? null : tmp_4_0.rol);
      }
    }, dependencies: [CommonModule, MatToolbarModule, MatToolbar, MatIconModule, MatIcon, MatButtonModule, MatIconButton, MatMenuModule, MatMenu, MatMenuItem, MatMenuTrigger], styles: ["\n\n.header-bar[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  z-index: 1000;\n  background: white;\n  border-bottom: 1px solid #e5e7eb;\n  height: var(--header-height);\n  box-shadow: var(--shadow-sm);\n}\n.turno-badge[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  margin-right: 16px;\n  padding: 4px 12px;\n  background: #ecfdf5;\n  border-radius: 12px;\n}\n/*# sourceMappingURL=header.component.css.map */"] });
  }
};
(() => {
...
function SidebarComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function SidebarComponent_For_7_Conditional_0_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function SidebarComponent_For_7_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 7)(1, "mat-icon", 8);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, SidebarComponent_For_7_Conditional_0_Conditional_3_Template, 2, 1, "span", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(3, !ctx_r1.collapsed ? 3 : -1);
  }
}
function SidebarComponent_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SidebarComponent_For_7_Conditional_0_Template, 4, 4, "a", 7);
  }
  if (rf & 2) {
    const item_r1 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional(0, !item_r1.roles || ctx_r1.tieneRol(item_r1.roles) ? 0 : -1);
  }
}
...
var SidebarComponent = class _SidebarComponent {
  constructor() {
    ...
    this.navItems = [
      ...
      { label: "Configuraci\xF3n", icon: "settings", route: "/configuracion", roles: ["ADMIN"] }
    ];
  }
  tieneRol(roles) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], inputs: { collapsed: "collapsed" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 2, consts: [[1, "sidebar-brand"], [1, "text-indigo-500"], [1, "font-bold", "text-lg", "ml-2"], [1, "sidebar-footer"], ["mat-list-item", "", 1, "cursor-pointer", 3, "click"], ["matListItemIcon", "", 1, "text-red-400"], [1, "text-red-400"], ["mat-list-item", "", "routerLinkActive", "active-link", 3, "routerLink", "title"], ["matListItemIcon", ""], ["matListItemTitle", ""]], template: function SidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "mat-icon", 1);
        \u0275\u0275text(2, "store");
        \u0275\u0275elementEnd();
        \u0275\u0275template(3, SidebarComponent_Conditional_3_Template, 2, 0, "span", 2);
        \u0275\u0275elementEnd();
        \u0275\u0275element(4, "mat-divider");
        \u0275\u0275elementStart(5, "mat-nav-list");
        \u0275\u0275repeaterCreate(6, SidebarComponent_For_7_Template, 1, 1, null, null, _forTrack0);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(8, "div", 3);
        \u0275\u0275element(9, "mat-divider");
        \u0275\u0275elementStart(10, "a", 4);
        \u0275\u0275listener("click", function SidebarComponent_Template_a_click_10_listener() {
          return ctx.auth.logout();
        });
        \u0275\u0275elementStart(11, "mat-icon", 5);
        \u0275\u0275text(12, "logout");
        \u0275\u0275elementEnd();
        \u0275\u0275template(13, SidebarComponent_Conditional_13_Template, 2, 0, "span", 6);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275conditional(3, !ctx.collapsed ? 3 : -1);
        \u0275\u0275advance(3);
        \u0275\u0275repeater(ctx.navItems);
        \u0275\u0275advance(7);
        \u0275\u0275conditional(13, !ctx.collapsed ? 13 : -1);
      }
    }, dependencies: [CommonModule, RouterModule, RouterLink, RouterLinkActive, MatListModule, MatNavList, MatListItem, MatListItemIcon, MatDivider, MatListItemTitle, MatIconModule, MatIcon, MatDividerModule], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  background: white;\n}\n.sidebar-brand[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  padding: 16px;\n  height: var(--header-height);\n}\n.sidebar-footer[_ngcontent-%COMP%] {\n  margin-top: auto;\n}\n.active-link[_ngcontent-%COMP%] {\n  background: rgba(63, 81, 181, 0.08) !important;\n  color: var(--color-primary) !important;\n  border-right: 3px solid var(--color-primary);\n}\n/*# sourceMappingURL=sidebar.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "src/app/layout/sidebar.component.ts", lineNumber: 23 });
})();

// src/app/core/services/inactividad.service.ts
var TIMEOUT_MS = 30 * 60 * 1e3;
var CHECK_INTERVAL_MS = 60 * 1e3;
var EVENTOS_ACTIVIDAD = [
  "mousemove",
  "keydown",
  "click",
  "scroll",
...
var InactividadService = class _InactividadService {
  constructor() {
    this.auth = inject(AuthService);
  ...
  verificar() {
    ...
    if (inactivo >= TIMEOUT_MS || this.tokenService.estaExpirado()) {
      this.zone.run(() => {
        this.detener();
        this.notify.info(inactivo >= TIMEOUT_MS ? "Sesi\xF3n cerrada por inactividad." : "Sesi\xF3n expirada.");
        this.auth.logout();
      });
    }
  }
  static {
    this.\u0275fac = function InactividadService_Factory(t) {
      return new (t || _InactividadService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _InactividadService, factory: _InactividadService.\u0275fac, providedIn: "root" });
  }
};
...
var ShellComponent = class _ShellComponent {
  constructor() {
    ...
    this.inactividad = inject(InactividadService);
    this.isMobile = toSignal(this.bp.observe([Breakpoints.Handset]).pipe(map((result) => result.matches)), { initialValue: false });
  }
  ngOnInit() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShellComponent, selectors: [["app-shell"]], viewQuery: function ShellComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c05, 5);
      }
      if (rf & 2) {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 7, vars: 3, consts: [["sidenav", ""], [3, "toggleSidebar"], [1, "shell-container"], [1, "shell-sidebar", 3, "mode", "opened"], [3, "collapsed"], [1, "shell-content"]], template: function ShellComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "app-header", 1);
        \u0275\u0275listener("toggleSidebar", function ShellComponent_Template_app_header_toggleSidebar_0_listener() {
          \u0275\u0275restoreView(_r1);
          const sidenav_r2 = \u0275\u0275reference(3);
          return \u0275\u0275resetView(sidenav_r2.toggle());
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(1, "mat-sidenav-container", 2)(2, "mat-sidenav", 3, 0);
        \u0275\u0275element(4, "app-sidebar", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "mat-sidenav-content", 5);
    ...
    }, dependencies: [CommonModule, RouterOutlet, MatSidenavModule, MatSidenav, MatSidenavContainer, MatSidenavContent, HeaderComponent, SidebarComponent], styles: ["\n\n.shell-container[_ngcontent-%COMP%] {\n  position: fixed;\n  top: var(--header-height);\n  bottom: 0;\n  left: 0;\n  right: 0;\n}\n.shell-sidebar[_ngcontent-%COMP%] {\n  width: var(--sidebar-width);\n  border-right: 1px solid #e5e7eb;\n}\n.shell-content[_ngcontent-%COMP%] {\n  background: var(--color-bg);\n  overflow-y: auto;\n}\n/*# sourceMappingURL=shell.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ShellComponent, { className: "ShellComponent", filePath: "src/app/layout/shell.component.ts", lineNumber: 19 });
})();
export {
  ShellComponent
};
//# sourceMappingURL=chunk-OCSWBERP.js.map
