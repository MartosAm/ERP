...
var ApiService = class _ApiService {
  ...
  get(path, params) {
    ...
    return this.http.get(`${this.base}/${path}`, { params: httpParams }).pipe(map((r) => r.datos));
  }
  /** GET paginado */
  getPaginado(path, params) {
    let httpParams = new HttpParams();
    if (params) {
      Object.entries(params).forEach(([k, v]) => {
        if (v !== void 0 && v !== null && v !== "") {
  ...
  /** POST genérico */
  post(path, body) {
    return this.http.post(`${this.base}/${path}`, body).pipe(map((r) => r.datos));
  }
  /** PUT genérico */
  put(path, body) {
    return this.http.put(`${this.base}/${path}`, body).pipe(map((r) => r.datos));
  }
  /** PATCH genérico */
  patch(path, body) {
    return this.http.patch(`${this.base}/${path}`, body).pipe(map((r) => r.datos));
  }
  /** DELETE genérico */
  delete(path) {
    return this.http.delete(`${this.base}/${path}`).pipe(map((r) => r.datos));
  }
  static {
...
@angular/platform-browser/fesm2022/platform-browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-QGQLHQW3.js.map
