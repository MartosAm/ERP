...
export const CrearProductoSchema = z.object({
  ...
  conversionUnidad: z.coerce.number().positive().optional(),
  cantidadMinimaVenta: z.coerce.number().positive().default(1),
  incrementoVenta: z.coerce.number().positive().default(1),

  // Precios
  precioCosto: z.coerce.number().min(0).default(0),
  precioVenta1: z.coerce.number().min(0).default(0),
  precioVenta2: z.coerce.number().min(0).optional(),
  precioVenta3: z.coerce.number().min(0).optional(),
  impuestoIncluido: z.boolean().default(true),
  tasaImpuesto: z.coerce.number().min(0).max(1).default(0.16),
...
export const ActualizarProductoSchema = z.object({
  ...
  conversionUnidad: z.coerce.number().positive().nullish(),
  cantidadMinimaVenta: z.coerce.number().positive().optional(),
  incrementoVenta: z.coerce.number().positive().optional(),
  precioCosto: z.coerce.number().min(0).optional(),
  precioVenta1: z.coerce.number().min(0).optional(),
  precioVenta2: z.coerce.number().min(0).nullish(),
  precioVenta3: z.coerce.number().min(0).nullish(),
  impuestoIncluido: z.boolean().optional(),
  tasaImpuesto: z.coerce.number().min(0).max(1).optional(),
  rastrearInventario: z.boolean().optional(),
  stockMinimo: z.coerce.number().min(0).optional(),
  stockMaximo: z.coerce.number().min(0).nullish(),
